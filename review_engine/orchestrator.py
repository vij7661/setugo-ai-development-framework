...
class ReviewEngine:
    ...
    def run(self, request: ReviewRequest, *, r1: ReviewerConfig, r2: ReviewerConfig | None, r3: ReviewerConfig | None, memory: VersionedMemoryStore | None = None) -> ReviewDecision:
        ...
        self._emit(session_id, "R2_COMPLETED", {
            ...
            "finding_count": len(r2_response.findings),
        ...
        correction_context.update({
            ...
            "verified_review_targets": [{
                ...
                "violated_invariant": f.violated_invariant, "affected_scope": list(f.affected_scope),
        ...
        self._emit(session_id, "R1_REVISED", {"previous_artifact_hash": artifact.artifact_hash, "artifact_hash": revised.artifact_hash, "trigger_finding_ids": [f.finding_id for f in r2_material]})
        ...
        self._emit(session_id, "R3_INDEPENDENT_COMPLETED", {"artifact_hash": revised.artifact_hash, "material_finding_ids": [f.finding_id for f in r3_material]})
        if not r3_material:
        ...
        self._emit(session_id, "R3_ADJUDICATION_COMPLETED", {"artifact_hash": revised.artifact_hash, "unresolved_finding_ids": [f.finding_id for f in unresolved]})
        if unresolved:
