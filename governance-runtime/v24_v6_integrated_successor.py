...
REQUIRED_ADVERSARIAL_CHECKS = frozenset(
    {
        ...
        "CANDIDATE_LD_PRELOAD_CONSUMER_INTERPOSITION_REJECTED",
        "CANDIDATE_FAKE_EUID_CONSUMER_REJECTED",
        "CANDIDATE_FAKE_RECORD_FILESYSTEM_CONSUMER_REJECTED",
        "DIRECT_CANDIDATE_CONSUMER_OUTPUT_NONAUTHORITATIVE",
        "TRUSTED_CONSUME_ENDPOINT_CANDIDATE_INACCESSIBLE",
        "TRUSTED_CONSUMER_RECOMPUTES_EXACT_REQUEST_BINDING",
        "GENUINE_ALLOW_RECORD_WRONG_OPERATION_REJECTED",
        "GENUINE_ALLOW_RECORD_WRONG_PAYLOAD_EFFECT_REJECTED",
        "TRUSTED_IN_SERVICE_CONSUME_POSITIVE",
    }
)
