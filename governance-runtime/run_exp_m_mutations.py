...
def run() -> dict:
    ...
    raw = b"a"; retrieval = RetrievalEvidenceRecord("r", "a", "s", "file", "v", 0, 1, digest(b"wrong"), len(b"wrong"), "tool", 1, "ctx", "ctx-h")
    retrieval_ok, retrieval_reasons = validate_retrieval(retrieval, expected_request="r", expected_attempt="a", expected_session="s", expected_source="file", expected_version="v", expected_context_id="ctx", expected_context_hash="ctx-h", authority=AUTHORITY)
    ...
    session_ok, session_reasons = validate_retrieval(retrieval_session, expected_request="r", expected_attempt="a", expected_session="s", expected_source="file", expected_version="v", expected_context_id="ctx", expected_context_hash="ctx-h", authority=AUTHORITY)
