...
DECISIONS={"PROMOTABLE","NONPROMOTABLE"}; STATES={"SUPPORTED","DEFECT","INSUFFICIENT"}
...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--benchmark',default='governance-runtime/exp-l/benchmark-v2.json'); ap.add_argument('--ground-truth',default='governance-runtime/exp-l/ground-truth-v2.json'); ap.add_argument('--model',required=True); ap.add_argument('--output-dir',required=True); a=ap.parse_args()
