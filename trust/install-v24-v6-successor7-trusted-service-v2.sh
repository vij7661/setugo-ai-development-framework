...
EXPECTED_MANIFEST_BLOB_SHA1="bbde11f1c6fd7d910b5fdb6deaf583244a731178"
...
test "$(jq -r '.schema_version' "$MANIFEST")" = "2"
test "$(jq -r '.file_hash_mode' "$MANIFEST")" = "git_blob_sha1"
test "$(jq -r '.manifest_id' "$MANIFEST")" = "V24-V6-SUCCESSOR7-TRUSTED-SERVICE-BOOTSTRAP-V2"
...
install -o root -g root -m 0444 "$MANIFEST"   "$TRUSTED_ROOT/bootstrap/v24-v6-successor7-trusted-service-bootstrap-v2.json"
...
chmod 0444 "$TRUSTED_ROOT/bootstrap/v24-v6-successor7-trusted-service-bootstrap-v2.json"
...
test "$(git hash-object "$TRUSTED_ROOT/bootstrap/v24-v6-successor7-trusted-service-bootstrap-v2.json")" = "$EXPECTED_MANIFEST_BLOB_SHA1"
