...
StableScopeValue must enforce the frozen ECMA pattern ^(?!ANY$).+; leading ECMA line terminators must reject while later line terminators remain allowed by the unanchored tail.
...
## Cadence
This is repair 1 of the active fallback maximum of three. No new Slice 26 construction may begin before the repaired Slices 20–22 receive fresh independent review.
