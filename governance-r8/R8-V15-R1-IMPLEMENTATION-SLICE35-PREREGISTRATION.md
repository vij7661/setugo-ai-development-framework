# R8 v15-r1 — Implementation Slice 35: Composite SPM-1 Provenance Family
...
## Goal
structurally validate the complete Schema Semantic Provenance Manifest family (root, GeneratorBinding, ArtifactBinding, ProvenanceEntry, SourceRef, coverage and catalog) in one composite slice.
...
## Explicit nonclaims
- source_ref referential integrity
- artifact_count/entry_count equality to arrays unless separately governed
- generator qualification authenticity
- final-freeze eligibility
- artifact/source existence
- source authority
- provenance semantic correctness
