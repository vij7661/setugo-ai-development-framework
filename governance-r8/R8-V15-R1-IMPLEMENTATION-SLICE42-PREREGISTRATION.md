# R8 v15-r1 — Implementation Slice 42: Schema Provenance Source Map Exact Freeze
...
## Goal
require semantic JSON equality to the frozen schema-provenance-source-map.json artifact only.
