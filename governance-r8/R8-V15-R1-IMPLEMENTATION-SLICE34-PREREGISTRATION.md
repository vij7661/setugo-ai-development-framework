# R8 v15-r1 — Implementation Slice 34: Local SPM SourceRef
...
## Goal
Implement exact local Schema Provenance Manifest SourceRef structure and string syntax only.
