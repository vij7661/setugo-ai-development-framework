# R8 v15-r1 — Implementation Slice 38: Composite GCP-RVM-2 Family
...
## Goal
structurally validate canonical/rejection vector definitions and root manifest without executing canonicalization or rejection semantics.
...
## Explicit nonclaims
- canonical UTF-8 recomputation
- SHA-256 recomputation
- rejection execution
- diagnostic-code semantic correctness
- source-case existence
- authority
