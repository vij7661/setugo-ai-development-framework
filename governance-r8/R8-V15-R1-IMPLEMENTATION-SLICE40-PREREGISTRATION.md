# R8 v15-r1 — Implementation Slice 40: Composite SPG-1 Binding Family
...
## Goal
structurally validate SchemaProvenanceGenerator binding and nested RuntimeManifest in one composite slice.
...
## Explicit nonclaims
- generator artifact authenticity
- runtime manifest digest recomputation
- workload attestation authenticity/currentness
- revocation currentness
- QUALIFIED truth
- final-freeze eligibility
- signing credential authority
