"""WDPC V24 I11 falsification harness contract V3.
...
HARNESS_VERSION="1.2.0-PLAN-REVIEW"
...
class InsufficientEvidenceEndpointCondition:
    ...
    def qualifies_for_endpoint_pass(self)->bool:
        return (
            self.case_execution_evidence_bundle_present
            ...
            and len(self.endpoint_trigger_evidence_digest)==64
...
def classify_negative(*,expected_endpoint:str,observed:GovernedEndpointObservation|None,effect:AuthorityEffectObservation|None,fixture_valid:bool,harness_valid:bool,ie_condition:InsufficientEvidenceEndpointCondition|None=None)->str:
    ...
    if expected_endpoint=="INSUFFICIENT_EVIDENCE":
        if ie_condition is None:return "FAIL_HARNESS_DEFECT"
        if not ie_condition.case_execution_evidence_bundle_present:return "NOT_EXECUTABLE_EXTERNAL_EVIDENCE_REQUIRED"
        if ie_condition.missing_case_execution_evidence:return "NOT_EXECUTABLE_EXTERNAL_EVIDENCE_REQUIRED"
