...
## Final append-only rerun

After restoring the frozen proof archive lost from `/tmp` by reboot and adding process-group cleanup for candidate diagnostic clients, the final append-only run was `/var/lib/v24-rq1/rq1-remediation-run-20260919m/RQ1-bundle.json`, SHA-256 `f878293e8fe8e27d5838a683556a7f03406f1a5cb813f7be9cf844013308ead9`. It contains 32 records with independent raw artifacts and reports `32 PASS`, `0 RED`, `0 HARNESS_DEFECT`, `0 INSUFFICIENT_EVIDENCE`. Earlier timeout/defect bundles remain historical and were not overwritten.

Final inherited reruns remain preserved as candidate transcript SHA-256 `12cb05f69b7c2b35079abd1850650c38e3c8758ae49f76138b7270ec987f1fb5` and root transcript SHA-256 `ec55a1ed7fab4c6c3712e3d8b68851a785b4e52aac524909e8be77ebed849303`. They contain context/setup and security-relevant failures requiring independent adjudication; they are not silently converted to qualification evidence.
