...
EXPECTED_REVIEW_BLOB=MANIFEST["reviews"]["expected_fresh_review_002"]["blob_sha1"]
OUT=pathlib.Path("stage2-sg1-review"); OUT.mkdir(exist_ok=True)
TARGET=OUT/"R8-V15-R1-STAGE2-SG1-CONSOLIDATED-REVIEW-002-PACKET.txt"
...
("governance-r8/R8-V15-R1-STAGE2-SG1-INDEPENDENT-EARLY-REVIEW-002.txt","FRESH INDEPENDENT EARLY REVIEW 002 — BOUNDED_PASS"),
...
if blob(BUNDLE_COMMIT, EXPECTED_REVIEW_PATH) != EXPECTED_REVIEW_BLOB:
    raise SystemExit("Review 002 does not match canonical manifest")
...
expected fresh review blob: {EXPECTED_REVIEW_BLOB}
