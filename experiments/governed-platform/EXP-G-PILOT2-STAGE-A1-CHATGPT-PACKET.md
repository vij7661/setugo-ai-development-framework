# EXP-G Pilot 2 — Stage A1 Isolated ChatGPT Packet

Use this packet in a **fresh ChatGPT conversation that has not seen any protected EXP-C/EXP-G adjudication**.
...
After the fresh ChatGPT returns its seven JSON objects, preserve its response **verbatim**. Do not correct or summarize it before Stage A2. Stage A2 Claude must receive this packet's case material plus the frozen A1 response only.
