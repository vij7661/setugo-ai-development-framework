# EXP-M Independent External Review Packet

## Packet status

`EXTERNAL_REVIEW_REQUESTED_NO_AUTHORITY_EFFECT`

This packet is a self-contained review representation for independent adversarial review of EXP-M Review Evidence Delivery & Reviewer Context Integrity.

It is **not** a platform-authenticated review execution, does not qualify EXP-M, does not promote any candidate, and does not retroactively validate any prior API review.
...
- reviewed source commit: `35fada32e3c09b7e43e286c4233d70a3b6f65273`
- reviewed source tree: `6ad30cf2ac592b16a7c128270e42823a26b2418a`

Reviewed file blobs:

- `standards/review-evidence-delivery-integrity.md` — `bcf1acbba9aceb6f1f8305396bdb4f61a1e054ff`
- `experiments/governed-platform/exp-m-review-evidence-delivery-integrity.md` — `2ee6c15750cbe5344a296f6f9448566b72bac90b`
- `experiments/governed-platform/EXP-M-TEST-MATRIX.md` — `df3d8e045a321637102184ddeef0436888a99573`
- `governance-runtime/LIVE-CONVERSATION-GOVERNANCE.md` — `e8434ed6b77f3355b554bdfed0305f9551ce792c`
- `experiments/governed-platform/EXP-M-SELF-ADJUDICATION.md` — `4f220dd33d5d71ecd0c110d2a7bcd7b501715ff1`

## Review posture

Assume false-green until proven otherwise.

The authoring model already performed iterative self-adjudication and stopped only after finding no additional Critical/High design defect. Do **not** accept that conclusion. Reconstruct the trust boundaries yourself.

## Primary review questions

1. Can a required evidence item still be omitted/downgraded before or during delivery while the platform reports completeness?
2. Can chunking, staged delivery, provider files, retrieval, or receipts overclaim reviewer-context availability?
3. Can candidate-controlled code still alter the materializer, manifest, transformer, provider capability profile, trusted adapter, completeness validator, or verdict-admissibility path used for its own review?
4. Does wire binding prove the exact frozen representation bytes were sent, including TOCTOU/retry/session/fallback behavior?
5. Can a provider capability profile become stale, self-authored, or overqualified by one lucky run?
6. Can lossy/partial transformations, archives, parser behavior, or egress/redaction alter decisive evidence while still appearing complete?
7. Can reviewer self-acknowledgement, citations, retrieval-tool output, external web/tools, or multi-reviewer consensus mint evidence completeness or authority?
8. Does the design correctly distinguish scientific evidence absence from materialization/delivery/context/format insufficiency?
9. Can review decomposition miss cross-evidence interactions yet produce a global PASS?
10. Are provider account/endpoint/region/model/deployment/session/file identities and drift bound strongly enough?
11. Are fresh witness probes meaningful without falsely claiming model attention?
12. Are archive/path/resource, evidence-ID collision, TOCTOU, retry, crash/history, and fallback cases sufficiently preregistered?
13. Does the standard make any claim that cannot actually be evidenced from normal provider APIs?
14. Are there any remaining Critical or High false-green, false-red, authority, privacy, provenance, or reproducibility defects?

## Required reviewer output

Return one design disposition:
...
- High findings
- Medium/Low findings
- required-evidence authority: PASS/FAIL
- delivery-governor trust root: PASS/FAIL
- manifest/wire binding: PASS/FAIL
- chunk/context model: PASS/FAIL
- provider capability qualification: PASS/FAIL
- representation/transformation safety: PASS/FAIL
- data egress/privacy boundary: PASS/FAIL
- session/file/retrieval binding: PASS/FAIL
- insufficient-evidence cause taxonomy: PASS/FAIL
- multi-reviewer equivalence: PASS/FAIL
- prompt/evidence-isolation dependency: PASS/FAIL
- test-matrix sufficiency: PASS/FAIL
- whether any Critical/High defect remains
- exact narrow corrections required
- whether EXP-M is ready for implementation/falsification
- explicit confirmation that this review does not qualify EXP-M or grant promotion authority

## Important nonclaims

The packet does not claim:
- EXP-M is implemented;
- provider limits are qualified;
- remote model attention is provable;
- the self-adjudication is independent;
- this packet transport is itself a platform review execution.

## Inline authoritative review material
...
Git blob: `bcf1acbba9aceb6f1f8305396bdb4f61a1e054ff`
...
Git blob: `2ee6c15750cbe5344a296f6f9448566b72bac90b`
...
Git blob: `df3d8e045a321637102184ddeef0436888a99573`
...
Git blob: `e8434ed6b77f3355b554bdfed0305f9551ce792c`
...
# INLINE SOURCE: experiments/governed-platform/EXP-M-SELF-ADJUDICATION.md

Git blob: `4f220dd33d5d71ecd0c110d2a7bcd7b501715ff1`
